...
ActiveRecord::Schema[7.1].define(version: 2024_07_03_005848) do
  ...
  create_table "cartings", force: :cascade do |t|
    ...
    t.index ["item_id"], name: "index_cartings_on_item_id"
    t.index ["shopper_id"], name: "index_cartings_on_shopper_id"
  end
  ...
  add_foreign_key "cartings", "items"
  add_foreign_key "cartings", "shoppers"
